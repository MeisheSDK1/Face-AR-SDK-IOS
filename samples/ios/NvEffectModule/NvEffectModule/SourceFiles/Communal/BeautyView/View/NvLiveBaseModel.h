...
@interface NvLiveBaseModel : NSObject
...
@property(nonatomic, assign) NSInteger
    categoryId; //如果素材有分类，设置不同的值。如粒子会有人脸、手势、全屏、触摸4中分类 // Set different values if assets are categorized. For example, particles will have face, gesture, full screen, touch 4 categories
