...
@class NvLiveSwitchView;
@class NvLiveBeautyView;
@class NvLiveCaptureFilterModel;
@class NvLiveBeautyViewModel;

@protocol NvLiveBeautyViewDelegate <NSObject>
@optional

/**
 选择或调节一个美颜、美型特效回调
 Select or adjust a beauty or beauty effect callback
 @param beautyView 当前NvLiveBeautyView对象，self
...
/**
 ...
 @param beautyView 当前NvLiveBeautyView对象，self
 @param array 回调的美型数据，一个NvLiveBeautyTypeModel的数组
 Callback beauty data, an array of NvLiveBeautyTypeModel
 */
...
@interface NvLiveBeautyView : UIView
...
@property(nonatomic, strong) NvLiveSwitchView *beautySwitch;
...
@property(nonatomic, strong) NvLiveSwitchView *beautyTypeSwitch;
...
@property(nonatomic, strong) NvLiveSwitchView *beautyTypeMicroSwitch;

@property(nonatomic, weak) id<NvLiveBeautyViewDelegate> delegate;

/// 0==美颜视图，1==美型视图，2==滤镜视图
/// 0== Beauty view, 1== Beauty view, 2== Filter view
@property(nonatomic, assign) NSInteger hiddenInteger;

@property(nonatomic, strong) NvLiveBeautyViewModel *viewModel;
...
/// @param array 一个NvLiveBeautyTypeModel的数组
